        ...
        <div className="fixed top-0 left-0 z-999999 flex h-full min-h-screen w-full items-center justify-center bg-black/90 px-4 py-5">
            ...
            <BsXCircleFill size={25} />
                ...
                <div className="-mx-3 flex flex-wrap gap-y-4">
                    ...
                    <div className="w-full px-3 2xsm:w-1/2">
                        <button onClick={() => onProceed()} className="block w-full rounded border border-meta-1 bg-meta-1 p-3 text-center font-medium text-white transition hover:bg-opacity-90">
                            {okText || 'Proceed'}
                        </button>
                    </div>
                </div>
