            ...
            <div className="col-span-12 flex flex-wrap items-center justify-between gap-3">
                    <nav>
                        <ul className="flex flex-wrap items-center gap-2">
                            <li aria-disabled={prevPage ? true : false} onClick={onPrevPage}><a className="flex items-center justify-center rounded bg-[#EDEFF1] py-1.5 px-3 text-xs font-medium text-black hover:bg-[#ff5500] hover:text-white dark:bg-graydark dark:text-white dark:hover:bg-[#ff5500' dark:hover:text-white" href="#/">Previous</a></li>
                            {
                                pages?.map((page, indexPage) => (
                                    <li key={indexPage} onClick={() => onSelectPage(page)}><a className={`flex items-center justify-center rounded py-1.5 px-3 font-medium hover:bg-[#ff5500] hover:text-white ${activePage === page ? ' bg-[#ff5500] text-white' : '' }`} href="#/">{page}</a></li>
                                ))
                            }
                            <li aria-disabled={nextPage ? true : false} onClick={onNextPage}><a className="flex items-center justify-center rounded bg-[#EDEFF1] py-1.5 px-3 text-xs font-medium text-black hover:bg-[#ff5500] hover:text-white dark:bg-graydark dark:text-white dark:hover:bg-[#ff5500] dark:hover:text-white" href="#/">Next</a></li>
                        </ul>
                    </nav>
