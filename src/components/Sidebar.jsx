  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5'>
        ...
        >
          <span className='text-white text-1xl'>DataCenter</span>
          {/* <Unknown /> */}
          ...
          <div>
            ...
            <ul className='mb-6 flex flex-col gap-1.5'>
              ...
              <li>
                <NavLink
                  to='/providers'
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('providers') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
                    className='fill-current'
              ...
              {/* <!-- Pending Dispatchers Table --> */}
              <li>
                <NavLink
                  to='/dispatchers/pendingDispatchers'
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('tables') && 'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <svg
