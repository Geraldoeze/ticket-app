...
const MultiSelect: React.FC<MultiSelectProps> = ({ options, onChange, label }) => {
...
const handleOptionClick = (option: Option) => {
  ...
  return (
    <div className="relative w-full">
      ...
      <div
        className="border bg-gray py-3 px-5 outline-none 
      ...
      {isOpen && (
        <div className="absolute z-10 mt-2 w-full bg-white dark:bg-form-input border border-gray-300 rounded-md shadow-lg">
          {options.map((option) => (
            <div
              key={option.value}
