...
export default function EmployeesFilter(props: EmployeesFilterProps) {
        ...
        <div>
          <div className="mb-4">
            ...
            <Checkbox
              name="age-18-24"
              value="18-24"
              isSelected={ages["age-18-24"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="age-25-30"
              value="24-30"
              isSelected={ages["age-25-30"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="age-31-35"
              value="31-35"
              isSelected={ages["age-31-35"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="age-36-40"
              value="36-40"
              isSelected={ages["age-36-40"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="age-above-40"
              value="above 40"
              isSelected={ages["age-above-40"]}
              onChecked={handleCheckedEvent}
            />
          </div>
          <div>
          ...
          <div>
            ...
            <Checkbox
              name="status-pending"
              value="pending"
              isSelected={status["status-pending"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="gender-active"
              value="active"
              isSelected={status["status-active"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="gender-suspended"
              value="suspended"
              isSelected={status["status-suspended"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="gender-transfered"
              value="transfered"
              isSelected={status["status-transfered"]}
              onChecked={handleCheckedEvent}
            />
          </div>
        </div>
        ...
        <div>
          <div className="mb-2">
            ...
            <Checkbox
              ...
              value="High School"
              isSelected={ages["edu-high-school"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="edu-college"
              value="College"
              isSelected={ages["edu-college"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="edu-ond"
              value="OND"
              isSelected={ages["edu-ond"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="edu-hnd"
              value="HND"
              isSelected={ages["edu-hnd"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="edu-bsc"
              value="BSc"
              isSelected={ages["edu-bsc"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="edu-msc"
              value="Msc"
              isSelected={ages["edu-msc"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="edu-phd"
              value="PHD"
              isSelected={ages["edu-phd"]}
              onChecked={handleCheckedEvent}
            />
          </div>
          <div>
            ...
            <Checkbox
              ...
              value="Admin"
              isSelected={ages["privilege-admin"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="privilege-account"
              value="Accountant"
              isSelected={ages["privilege-account"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="privilege-registrar"
              value="Registrar"
              isSelected={ages["privilege-registrar"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="privilege-admission"
              value="Admission"
              isSelected={ages["privilege-admission"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="privilege-hostel"
              value="Hostel"
              isSelected={ages["privilege-hostel"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="privilege-academic"
              value="Academic"
              isSelected={ages["privilege-academic"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="privilege-facilities"
              value="Facilities"
              isSelected={ages["privilege-facilities"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="privilege-vehicles"
              value="Vehicles"
              isSelected={ages["privilege-vehicles"]}
              onChecked={handleCheckedEvent}
            />
          </div>
        </div>
        ...
        <div>
          <div className="mb-2">
            ...
            <Checkbox
              name="kg"
              value="KG & Nurs"
              isSelected={ages["cls-kg-nurs"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="pry-1-6"
              value="Primary"
              isSelected={ages["pri-1-6"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="pry-1-3"
              value="PRI 1-3"
              isSelected={ages["pri-1-3"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="pri-4-6"
              value="PRI 4-6"
              isSelected={ages["pri-4-6"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="sec-1-6"
              value="Secondary"
              isSelected={ages["sec-1-6"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="sec-1-3"
              value="JSS 1-3"
              isSelected={ages["sec-1-3"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="sec-4-6"
              value="SSS 1-3"
              isSelected={ages["SSS 1-3"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="sec-4-6"
          ...
          <div className="mb-2">
            ...
            <Checkbox
              name="type-fulltime"
              value="full-time"
              isSelected={ages["type-fulltime"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="type-parttime"
              value="part-time"
              isSelected={ages["type-parttime"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="type-subtitute"
              value="subtitute"
              isSelected={ages["type-subtitute"]}
              onChecked={handleCheckedEvent}
            />
            <Checkbox
              name="type-contract"
              value="contract"
              isSelected={ages["type-contract"]}
              onChecked={handleCheckedEvent}
            />
          </div>
        </div>
