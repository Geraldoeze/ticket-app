...
export default function Parents() {
  ...
  return (
    <DefaultLayout>
      <Breadcrumb
        pageName="Parents"
        homeRoute={ROUTES_CONFIG.admin.entities.parents}
      ...
      <Table.HeaderView>
        <Table.HeaderViewItem>
          <Table.SearchTable
            ...
            placeholder="Search Parent List..."
            value={search}
            onChange={setSearch}
      ...
      <Table show>
        <Table.TableRow>
          ...
          <Table.Row>No. of Children</Table.Row>
          <Table.Row>Phone</Table.Row>
          <Table.Row>Email</Table.Row>
          <Table.Row>Relationship</Table.Row>
        </Table.TableRow>
        ...
        <Table.TableItems>
          {checkData?.map((user: any, index: number) => (
            ...
            >
              ...
              <Table.Cell>{user?.numberOfChildren}</Table.Cell>
              <Table.Cell>{user?.phone}</Table.Cell>
              <Table.Cell>{user?.email}</Table.Cell>
              <Table.Cell>{user?.relationship}</Table.Cell>
            </Table.CellRows>
          ))}
        </Table.TableItems>
      </Table>
